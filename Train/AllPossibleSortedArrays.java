		 ...
		 if (flag) // Include valid element from A 
	        { 
	            ...
	            { 
	                ...
	                { 
	                    ...
	                    C[len] = A[k]; 
	                    System.out.println("A len: "+len+" C["+len+"]: "+C[len]+" flag: "+flag);
	                    // don't increment len as B is not included yet 
	                ...
	                { 
	                        C[len + 1] = A[k]; 
	                        System.out.println("B len: "+len+" C["+(len+1)+"]: "+C[len+1]+" flag: "+flag);
	        ...
	        { 
	            ...
	            { 
	                ...
	                { 
	                    C[len + 1] = B[l]; 
	                    System.out.println("C len: "+len+" C["+(len+1)+"]"+C[len+1]+" flag: "+flag);
